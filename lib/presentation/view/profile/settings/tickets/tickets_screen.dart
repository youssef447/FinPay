...
import 'package:finpay/presentation/view/profile/settings/tickets/add_ticket.dart';
import 'package:finpay/presentation/view/profile/settings/tickets/ticket_details_screen.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor:
            AppTheme.isLightTheme == false ? HexColor('#15141f') : Colors.white,
        title: Text(
          AppLocalizations.of(Get.context!)!.tickets,
                    ...
                    : controller.tickets.isEmpty
                        ? Center(
                            child: NoDataScreen(
                              ...
                              title: AppLocalizations.of(context)!.no_tickets,
                            ),
                          )
                        : ListView.separated(
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    ...
                                    Positioned(
                                      ...
                                      top: 10,
                                      child: Text(
                                        '${AppLocalizations.of(Get.context!)!.created_at} ${controller.tickets[index].createdAt ?? 'N/a'}',
                                        style: Theme.of(context)
                                            .textTheme
                                            .bodyMedium!
                                            .copyWith(
                                    ...
                                    Positioned(
                                      ...
                                      child: Text(
                                        controller
                                            ...
                                            ? AppLocalizations.of(Get.context!)!.no_replies
                                            : '${AppLocalizations.of(Get.context!)!.replies} ${controller.tickets[index].replies.length}',
                                        style: Theme.of(context)
                                            .textTheme
                                            .bodyMedium!
                                            .copyWith(
