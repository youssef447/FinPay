                              ...
                              onTap: () {
                                if (formKey.currentState!.validate()) {
                                  if (serviceController.pickedField.isEmpty) {
                                    Get.defaultDialog(
                                      middleText: 'You must Select a Field',
                                      title: 'Warning',
                                      ...
                                      .isEmpty) {
                                    Get.defaultDialog(
                                      middleText: 'You must Select a Wallet',
                                      title: 'Warning',
                                      confirmTextColor: Colors.black,
                                      onConfirm: () {
                                        Get.back();
                                    ...
                                    Get.defaultDialog(
                                      middleText: 'You must provide a Name',
                                      title: 'Warning',
                                      confirmTextColor: Colors.black,
                                      onConfirm: () {
                                        Get.back();
